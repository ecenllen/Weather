...
import com.kaku.weac.activities.CpuWebActivity;
...
import com.kaku.weac.activities.TuiJianActivity;
...
//        OverScrollDecoratorHelper.setUpOverScroll(scrollView);
        ...
        if (!AppConfig.isShowCpuWeb()) {
            ...
            view.findViewById(R.id.theme).setVisibility(View.VISIBLE);
        }
        // 主题
        view.findViewById(R.id.theme).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyUtil.startActivity(getActivity(), CpuWebActivity.class);
            }
        });
        if (!AppConfig.isShowSelfAD()) {
            view.findViewById(R.id.tuijian).setVisibility(View.GONE);
        }else {
            view.findViewById(R.id.tuijian).setVisibility(View.VISIBLE);
        }
        view.findViewById(R.id.tuijian).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (MyUtil.isFastDoubleClick()) {
                    return;
                }
                MyUtil.startActivity(getActivity(), TuiJianActivity.class);
            }
        });
